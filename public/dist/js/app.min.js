        ...
        ManageSidebarType: function() {
            switch (settings.SidebarType) {
                ...
                case 'full':
                    ...
                    $(".sidebartoggler i").removeClass("mdi-toggle-switch-off");
                    //****************************
...
/*
	var $viewsDetailsBlock = $('.stats-views-details');
	window.chartViewsColors = [];
	for (var k in window.viewCircle){
		if (window.viewCircle[k]) {
			window.chartViewsColors.push(window.viewCircle[k][2]); // color
$viewsDetailsBlock.append( '<div class="col-4 border-right"><i class="fa fa-circle" style="color:'+window.viewCircle[k][2]+';"></i><h4 class="mb-0 font-medium">'+window.viewCircle[k][1]+'</h4><span>'+window.viewCircle[k][0]+'</span></div>' );
		}
	}		
	*/
